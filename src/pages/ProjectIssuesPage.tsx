  ...
  return (
    <div className="project-issues-page">
      ...
      {issuesLoading ? (
        ...
        <IssueList issues={issues} showAuthor showAssignee statuses={statuses} onStatusChange={handleStatusChange} priorities={priorities} onPriorityChange={handlePriorityChange} />
      )}
    </div>
  );
}
